...
// (tools/vscode/sim/pkg/). Lazily initialises the wasm module from the
...
// tools/vscode/sim/rust/src/lib.rs. JS-side consumers compare against
 ...
 * handlers (matching tools/theia/sim/host_calls.py DefaultHostCalls).
