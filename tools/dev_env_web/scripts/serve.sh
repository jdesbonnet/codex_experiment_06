...
# tools/dev_env_web/extension/ into a self-hosted VS Code Web instance via
...
#
#   tools/dev_env_web/scripts/serve.sh          # serves on 127.0.0.1:3000
#   PORT=3001 tools/dev_env_web/scripts/serve.sh

set -euo pipefail

ROOT=$(cd "$(dirname "${BASH_SOURCE[0]}")/../../.." && pwd)
EXT="$ROOT/tools/dev_env_web/extension"
HOST="$ROOT/tools/dev_env_web/host"
PORT_ARG=${PORT:-3000}
