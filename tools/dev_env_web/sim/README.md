...
Rust + wasm-bindgen port of `tools/dev_env/sim/tiny_vm_sim.py`, which is itself
...
The browser-side DAP server (`tools/dev_env_web/extension/`, **M3**) will
...
`tools/dev_env/sim/host_calls.py` pops args off the vm itself.
