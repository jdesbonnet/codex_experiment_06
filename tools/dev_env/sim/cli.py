...
Usage:
    tools/dev_env/sim/cli.py <bin>
    tools/dev_env/sim/cli.py <bin> --trace
    tools/dev_env/sim/cli.py <bin> --halt-banner   # emit 'tiny_vm: halt' after HALT
"""
...
def _ensure_package_on_path() -> None:
    ...
    # The package is `tools/dev_env/sim`; we need `tools/dev_env` on sys.path
